...
def learning():
    ...
    paths = [ 'results',
              ...
              os.path'results' , theme_name , 'sklearn', 'tree'),
              os.path'results' , theme_name , 'sklearn', 'importance'),
              os.path'results' , theme_name , 'sklearn', 'parameter_raw'),
              os.path'results' , theme_name , 'sklearn', 'parameter_std'),
              os.path'results' , theme_name , 'sklearn', 'predict_raw'),
              os.path'results' , theme_name , 'sklearn', 'predict_stdtoraw'),
              os.path'results' , theme_name , 'sklearn', 'traintest_raw'),
              os.path'results' , theme_name , 'sklearn', 'traintest_std'),
              os.path'results' , theme_name , 'sklearn', 'traintest_stdtoraw'),
              os.path'results' , theme_name , 'sklearn', 'scatter_diagram'),
              os.path'results' , theme_name , 'sklearn', 'bayesian_opt'),
              os.path'results' , theme_name , 'deeplearning'),
              os.path'results' , theme_name , 'deeplearning', 'h5'),
              os.path'results' , theme_name , 'deeplearning', 'traintest'),
              os.path'results' , theme_name , 'deeplearning', 'predict')]
